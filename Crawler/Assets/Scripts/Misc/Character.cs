...
public class Character : Photon.MonoBehaviour {
	...
	float[] attackRanges = new float[] { 7.5f, 1.5f, 10f, 1.5f, 6.5f, 6.5f, 1.5f, 1.5f }; // Range of attack
	int[] damages = new int[] { 10, 20, 15, 25, 5, 15, 5, 50 };  // Amount of damage
	float[] attackIntervals = new float[] { 0.2f, 0.4f, 0.3f, 0.45f, .5f, .75f, .5f, 1.5f }; // Attack interval
